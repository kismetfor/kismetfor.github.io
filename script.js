...
document.addEventListener('DOMContentLoaded', function() {
    ...
    yesButton.addEventListener('click', function() {
        mainImage.src = 'assets/images/hug.webp';
        question.textContent = '!!!喜欢你!! ( >᎑<)♡︎ᐝ  ♡︎ᐝ(>᎑< )';
...
function getTranslation(key) {
    const translations = {
        "pageTitle": "小郁想我了吗？",
        "greeting": "晚上好呀宝宝？(*>﹏<*)",
        "subGreeting": "小郁肯定想我了吧",
        "freeNotice": "ฅ•ω•ฅ 今天有没有好好吃饭呀",
        "questionTemplate": "小郁想我了吧？ฅ•ω•ฅ ",
        "loveMessage": "!!!喜欢你!! ( >᎑<)♡︎ᐝ  ♡︎ᐝ(>᎑< )",
        "yesButton": "肯定想了呀",
        "noButton": "才没想呢"
    };
